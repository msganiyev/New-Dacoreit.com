...
/* @var $searchModel backend\models\PostCatSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'Post Cats');
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="post-cat-index">


    <p class="float-right">
        <?= Html::a(Yii::t('app', 'Create Post Cat'), ['create'], ['class' => 'btn btn-info']) ?>
    </p>
